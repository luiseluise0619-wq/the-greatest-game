...
```
npm test               # 230 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 230 checks on plain Node, no browser and no extra dependencies.
