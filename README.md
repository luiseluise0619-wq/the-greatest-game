...
```
npm test               # 217 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 217 checks on plain Node, no browser and no extra dependencies.
