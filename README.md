...
```
npm test               # 219 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 219 checks on plain Node, no browser and no extra dependencies.
