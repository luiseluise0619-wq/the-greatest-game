...
```
npm test               # 235 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 235 checks on plain Node, no browser and no extra dependencies.
