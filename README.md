...
```
npm test               # 240 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 240 checks on plain Node, no browser and no extra dependencies.
