...
```
npm test               # 229 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 229 checks on plain Node, no browser and no extra dependencies.
