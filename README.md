...
```
npm test               # 231 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 231 checks on plain Node, no browser and no extra dependencies.
