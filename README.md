...
```
npm test               # 233 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 233 checks on plain Node, no browser and no extra dependencies.
