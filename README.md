...
```
npm test               # 216 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 216 checks on plain Node, no browser and no extra dependencies.
