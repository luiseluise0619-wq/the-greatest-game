...
```
npm test               # 236 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 236 checks on plain Node, no browser and no extra dependencies.
