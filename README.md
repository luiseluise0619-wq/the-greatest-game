...
```
npm test               # 238 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 238 checks on plain Node, no browser and no extra dependencies.
