...
```
npm test               # 232 checks: map, collision, match rules, information rules, cards, anti-cheat
...
`npm test` runs 232 checks on plain Node, no browser and no extra dependencies.
