...
const KO = {
  ...
  'man.key.cards': '<b>1…9 0</b> 카드 내기',
  'man.key.brace': '<b>Space</b> 몸을 피하기',
  'man.key.look': '<b>마우스</b> 고개 돌리기 — 발은 그대로',
  'man.key.self': '<b>K</b> 자기 머리에 겨누기',
  'man.key.gunhand': '<b>G</b> 손재주 — 누르는 종류라면',

  // ---------------------------------------------------------- the manual
  'ui.howToPlay': '게임 방법',
  'ui.theEighty': '여든 장',
  'ui.dealtGunhand': '손재주는 골라지지 않고 주어집니다',
  ...
  'rules.ammo': '<b>탄약은 카드입니다.</b> 손에 「한 발」이 없으면 쏠 수 없고, 총이 닿는 거리는 앞에 깔린 카드가 정합니다.',
  ...
  'man.tableTitle': '탁자',
  'man.table': '이 게임은 큰길 한복판의 <b>탁자 앞에 서서</b> 합니다. 설 자리를 하나 받고, 판이 끝날 때까지 거기 서 있습니다 — 아무도 걷지 않습니다. <b>거리는 자리 수</b>입니다. 옆 사람은 한 자리, 맞은편은 서너 자리이고, 당신 총은 앞에 깔린 카드가 말하는 자리 수만큼 닿습니다. 어디에 섰는지도 손에 든 카드와 마찬가지로 당신이 고른 것이 아닙니다.',
  'man.lapTitle': '한 바퀴',
  'man.lap': '<b>한 사람씩 차례를 갖습니다</b>. 각 6초, 판 시작 때 탁자 전체가 본 순서대로. 한 바퀴와 다음 바퀴 사이에는 짧은 틈이 있어, 각자 무엇을 썼는지 헤아릴 수 있습니다. 고개는 언제든 돌릴 수 있습니다. 남의 차례에 할 수 있는 일은 그것뿐이지만, 그것으로 충분합니다 — 누구든 받는 유일한 경고는 상대가 총을 드는 것을 보는 것이니까요.',
  'man.fireTitle': '쏘려면 무엇이 필요한가',
  'man.fire': '세 가지가 동시에 맞아야 합니다. <b>당신의 차례</b>여야 하고, 손에 <b>「한 발」</b>이 있어야 하며 — 한 차례에 한 장, 맞히든 못 맞히든 소모됩니다 — 상대가 <b>당신 총이 닿는 거리 안</b>에 있어야 합니다. 그 거리는 조준경이 아니라 당신 앞에 깔린 카드가 정하며, <b>자리 수</b>로 셉니다 — 몇 자리까지 닿는지는 화면 구석에 적혀 있습니다. 벨트 권총은 양옆 이웃까지만 닿으니, 탁자의 대부분은 대개 사거리 밖입니다. 규칙이 거부할 상대에게는 총이 아예 들리지 않고, 왜인지도 알려 줍니다. 방아쇠가 응답할 카드는 아직 쏠 수 있는 동안 손에서 <b>불이 들어와 있고</b>, 한 발을 쏘고 나면 꺼집니다.',
  ...
  'man.selfTitle': '총구를 자기에게',
  'man.self': '이 마을에서는 누구도 자기가 결백하다는 걸 증명할 수 없고, 말은 공짜입니다. 그래서 공짜가 아닌 말이 딱 하나 있습니다 — 보는 사람이 있을 때 <b>K</b>를 누르면 <b>자기 총을 자기 머리에 대고 방아쇠를 당깁니다</b>. 여섯 번 중 다섯 번은 딸깍하고, 그 장면을 실제로 본 사람은 — 가까이서, 당신을 향해, 사이에 가린 것 없이 — 당신에 대한 생각을 고쳐먹게 됩니다. 계획이 있는 무법자라면 미치지 않고서야 하지 않을 짓이니까요. 나머지 한 번은 진짜 실탄이고, 목숨의 대부분을 가져갑니다. <b>한 판에 한 번</b>, 그리고 누군가 보고 있을 때만 — 혼자 하면 아무것도 사지 못합니다.',
  'man.handTitle': '당신이 받은 사람',
  'man.hand': '역할과 함께 <b>열여섯 가지 손재주</b> 중 하나를 받고, 역할 카드에 적혀 있습니다. 맞을 때마다 손에 카드가 한 장씩 늘어나는 자가 있고, 그를 피하려면 <b>「빗나감」</b>이 두 장 필요한 자가 있으며, 손이 절대 비지 않는 자가 있고, 쓰러진 자들의 주머니를 전부 챙기는 자가 있습니다. 남이 무엇을 받았는지는 아무도 모릅니다 — 다만 대부분은 처음 쓰이는 순간 드러납니다.',
  'man.cardsTitle': '여든 장',
  'man.cards': '손에 들 수 있는 카드 수는 당신의 체력과 같고, 차례가 시작될 때마다 두 장을 뽑습니다 — 죽음에 가까울수록 할 수 있는 일이 줄어듭니다. 카드에 적힌 <b>숫자키</b>로 냅니다 — 1부터 9까지, 열 번째는 <b>0</b>입니다. 어떤 카드는 먼저 상대를 조준해야 합니다. <b>「한 발」</b>과 <b>「빗나감」</b>은 키로 내지 않습니다. 하나는 쏘는 것이고, 하나는 당신이 몸을 피할 때 대신 나갑니다.',
  ...
  'duel.aimToFire': '조준한 채로 버티면 발사됩니다',
  'deny.shotSpent': '이번 차례의 한 발은 이미 썼습니다.',
  'deny.nothingToSpin': '실린더에 돌릴 것이 없습니다.',
  'deny.noBang': '쏠 카드가 손에 없습니다.',
  'duel.shotGone': '이번 차례의 한 발은 이미 썼습니다',
  'duel.forTheirGo': '남의 차례에 쓰는 카드입니다',
  'duel.outOfReach': '너무 멉니다. 총이 닿는 거리는 앞에 깔린 카드가 정합니다.',
  'man.readTitle': '판 읽기',
  ...
  'bot.sus3.duel': '{name} — 이번 바퀴에 나를 두 번 쳐다봤습니다.',
  'bot.sus4': '{place} 쪽에서 총소리가 났습니다.',
  'bot.sus4.duel': '누군가의 총이 방금 울렸습니다. 그게 누구 차례였죠?',
  ...
  'bot.hu1': '맞았습니다! 쏜 건 {name}입니다!',
  'bot.hu2': '{place} 근처에서 누가 나한테 납을 박았습니다.',
  'bot.hu2.duel': '한 대 맞았습니다. 그게 누구 차례였든, 나는 기억합니다.',
  'bot.la1': '당신들이 뭘 믿든, 나는 법 쪽입니다.',
  'bot.la2': '내려놓으십시오. 오늘 아무도 묻히지 않아도 됩니다.',
  'hud.deadTag': '(사망)',
  'hud.beltGun': '벨트 총',
  'hud.seatOfReach': '자리까지 닿음',
  'hud.seatsOfReach': '자리까지 닿음',
  'hud.metres': 'm 사거리',
  ...
  'intel.notLaw': '새벽에 선서하면서 이름 하나를 받았습니다 — {name}. 별의 편이 아닙니다.',
  ...
  'feed.neverMoved': '막을 카드가 손에 있었는데 움직이지 않았습니다.',
  'feed.patchedYou': '{name} — 당신을 치료했습니다 (+{n}).',
  'feed.youPatched': '{name} — 당신이 치료해 주었습니다.',
  'feed.bandagedSelf': '스스로 붕대를 감았습니다 (+{n}).',
  'feed.callsOut': '{a} — {b}에게 손가락을 겨눕니다.',
  'feed.squareOff': '{a} — {b}에게 결투를 신청합니다. 한 발씩 주고받다 먼저 떨어지는 쪽이 맞습니다.',
  'feed.pinsStar': '{name} — 별을 달고 법을 자처합니다. 믿을지 말지는 각자 알아서.',
  'feed.starIsOn': '{name} — 별을 답니다. 그것만큼은 마을 전체가 확실히 압니다.',
  ...
  'feed.lobbyReady': '{name} — 준비 완료 ({n}/{of}).',
  'feed.lobbyNotReady': '{name} — 준비를 물렀습니다 ({n}/{of}).',
  'feed.posterStar': '벽보가 답합니다 — {name}, 별을 달고 있습니다.',
  'feed.posterNoStar': '벽보가 답합니다 — {name}, 별을 달고 있지 않습니다.',
  'err.noSuchTown': '"{code}" 이름의 마을은 없습니다. 코드를 확인하십시오.',
  'err.townFull': '그 마을은 꽉 찼습니다 — 총 여덟 자루가 한계입니다.',
  'err.atCapacity': '서버가 가득 찼습니다. 잠시 뒤 다시 시도해 주십시오.',
  ...
  'feed.rolesDealt': '역할이 돌아갔습니다. 교회 종이 울릴 때까지 총은 총집에.',
  // 자유 대전 — 자기 총을 자기 머리에
  'feed.notYet': '아직입니다. 종이 울리기 전에는 안 됩니다.',
  'feed.oneGambleOnly': '이번 판에 그 내기는 이미 걸었습니다.',
  'feed.nothingToSpin': '실린더에 돌릴 것이 없습니다.',
  'feed.nobodyWatching': '아무도 보고 있지 않습니다. 혼자 할 이유가 없습니다.',
  'feed.itClicked': '딸깍. 그걸 본 사람은 이제 당신을 다시 생각해야 합니다.',
  'feed.sawItClick': '{name} — 당신이 보는 앞에서 자기 총을 자기 머리에 댔고, 딸깍했습니다.',
  'feed.itWasLoaded': '하필 그 한 발이었습니다.',
  'feed.sawItFire': '{name} — 당신이 보는 앞에서 자기 총을 자기 머리에 댔고, 그것은 실탄이었습니다.',
  ...
  'deny.noGun': '허리에 그런 총은 없습니다 — {name}.',
