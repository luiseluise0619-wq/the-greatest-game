...
const KO = {
  ...
  'rules.turns': '<b>순서를 지켜 가며 합니다.</b> 다 같이 걷는 시간이 끝나면, 한 사람씩 6초 동안 마을에서 유일하게 살아있는 총을 쥡니다 — 그동안 아무도 걷지 못합니다.',
  ...
  'man.lapTitle': '한 바퀴',
  'man.lap': '한 판은 여러 바퀴이고, 한 바퀴는 두 부분입니다. 먼저 <b>다 같이 걷고</b> 아무도 쏠 수 없습니다 — 자리를 잡을 15초입니다. 그다음 <b>한 사람씩 차례를 갖습니다</b>. 각 6초, 판 시작 때 마을 전체가 본 순서대로. 그리고 누군가의 차례인 동안에는 <b>아무도 걷지 못합니다</b>. 고개는 돌릴 수 있습니다. 남의 차례에 할 수 있는 일은 대체로 그것뿐입니다.',
  ...
  'man.self': '자기 차례에는 <b>Q</b>로 총구를 자기 머리에 댈 수 있습니다. 공포탄이면 그 자리에서 차례를 한 번 더 얻습니다. 실탄이면 한 대 맞고, 총알은 거기서 멈추지 않고 <b>등 뒤로 빠져나가</b> 당신 뒤에 일직선으로 서 있던 사람에게 갑니다. 걷는 동안 다들 어디에 섰는지 봐 둘 이유가 여기 있습니다.',
  'man.cardsTitle': '여든 장',
