...
const KO = {
  ...
  'man.fire': '세 가지가 동시에 맞아야 합니다. <b>당신의 차례</b>여야 하고, 손에 <b>「한 발」</b>이 있어야 하며 — 한 차례에 한 장, 맞히든 못 맞히든 소모됩니다 — 상대가 <b>당신 총이 닿는 거리 안</b>에 있어야 합니다. 그 거리는 조준경이 아니라 당신 앞에 깔린 카드가 정하며, <b>자리 수</b>로 셉니다 — 몇 자리까지 닿는지는 화면 구석에 적혀 있습니다. 벨트 권총은 양옆 이웃까지만 닿으니, 탁자의 대부분은 대개 사거리 밖입니다. 규칙이 거부할 상대에게는 총이 아예 들리지 않고, 왜인지도 알려 줍니다.',
