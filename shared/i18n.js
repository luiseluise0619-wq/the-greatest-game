...
const KO = {
  ...
  'man.self': '자기 차례에는 <b>Q</b>로 총구를 자기 머리에 댈 수 있습니다. 공포탄이면 그 자리에서 차례를 한 번 더 얻습니다. 실탄이면 한 대 맞고, 총알은 거기서 멈추지 않고 <b>등 뒤로 빠져나가</b> 당신 뒤에 일직선으로 선 사람에게 갑니다 — 둥근 탁자에서는 반대쪽 옆 사람입니다. 왼쪽 옆 사람을 향해 돌아서면, 그 총알은 오른쪽 옆 사람이 받습니다. 몸을 빠져나온 뒤로는 여느 총알과 다르지 않습니다 — <b>뒤에 선 사람의 빗물통은 그대로 막아 주고</b>, 마침 몸을 피하고 있던 사람도 마찬가지입니다.',
